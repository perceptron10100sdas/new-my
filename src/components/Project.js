...
export default function project() {
  return (
    ...
    <div  className='bg-gradient-to-r from-orange-500 to-yellow-400 '>
      ...
      <Link href="https://google-clone-lyart-gamma.vercel.app/" className='text-2xl text-white font-bold bg-gradient-to-r from-yellow-500 to-blue-700 rounded-md hover:underline'>Google clone </Link>
