...
export default function project() {
  return (
    ...
    <div  className='bg-gradient-to-r from-orange-500 to-yellow-400 '>
     ...
     <div className='mt-4'>
       <a href="https://imdb-perceptron10100.vercel.app/" > <Image src="https://media.licdn.com/dms/image/sync/D4D27AQELVH_B4fZxYw/articleshare-shrink_800/0/1692787656758?e=1693998000&v=beta&t=N-rabvdLiDPfV0mK64jZCws2rcBBa7QQ6mBEjsBUoAU"
        width={500}
        height={500}
       
      
        className='ring-2 hover:ring-black rounded-none'/></a>
      
        <div className='flex justify-end'><Link href="https://github.com/perceptron10100sdas/imdb" className='font-bold text-black bg-gradient-to-r from-green-400 to-blue-500 hover:from-pink-500 hover:to-yellow-500py-1 px-1 rounded-lg mr-1'>Source Code for Imdb</Link><img src='https://play-lh.googleusercontent.com/PCpXdqvUWfCW1mXhH1Y_98yBpgsWxuTSTofy3NGMo9yBTATDyzVkqU580bfSln50bFU'
         width={50}
         height={50}/></div>
    ...
    <div className='mt-4'>  
<a href='https://astounding-kringle-914635.netlify.app/'><Image src="https://media.licdn.com/dms/image/D4D2DAQFIbwUnIWZ0ig/profile-treasury-image-shrink_800_800/0/1692787404978?e=1693998000&v=beta&t=tiuOTHPECR5nzy8x3yTNdOmbhNRxfGpviNYwkW2ExvM"

width={500}
height={500}
className='ring-2 hover:ring-green-950 rounded-none'/></a>
...
<Link href="https://astounding-kringle-914635.netlify.app/" className='text-2xl text-white bg-gradient-to-r from-green-950 to-black py-1 px-1 rounded-md font-semibold'>Starbucks Clone</Link>
<p className='text-white'>Starbucks clone made using React and inline css</p>
</div>  

<h1 className='text-2xl bg-gradient-to-r from-fuchsia-700 to-black italic mt-3'>More projects coming up including instagram,X etc...</h1>
      </div>
